  ...
  return (
    <>
      <div className='flex gap-7'>
        <div className='bg-[white] w-[1007px] h-[1066px] rounded-2xl'></div>
        ...
        <div className='flex flex-col gap-6'>
          ...
          <div className='bg-[white] w-[428px] h-[183px] rounded-2xl flex flex-4'>
            <div className='w-6 h-[183px]  bg-[#FB7D5B] rounded-s-2xl'></div>
            <div className='p-5 w-full'>
              <h1 className='text-lg font-semibold leading-normal text-[#363B64]'>
                Basic Algorithm
              </h1>
