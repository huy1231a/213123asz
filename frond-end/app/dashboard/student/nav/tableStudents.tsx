...
import { eachDayOfInterval, startOfToday, format } from "date-fns";
...
const TableStudent = () => {
  ...
  return (
    <div
      className="ml-5 bg-white rounded-2xl p-5 h-auto"
      style={{ width: 1415 }}
    >
      <table className="w-full text-left rtl:text-right ">
        <thead className="">
          <tr className="text-sm leading-normal font-semibold text-[#303972]">
        ...
        <tbody>
          <tr className="border-t border-gray-200">
            <th
              scope="row"
              className="p-5 font-medium text-gray-900 whitespace-nowrap dark:text-white"
            >
              <div className="flex gap-4 items-center">
                <input
                  type="checkbox"
                ...
                />
                <p className="text-lg font-bold leading-normal text-[#303972]">
                  Samanta William
                </p>
              </div>
            </th>
            <td className="px-6 py-4 font-semibold text-[#4D44B5]">
              #123456789
            </td>
            <td className="px-6 py-4 text-sm font-normal leading-normal text-[#A098AE]">
            ...
            <td className="px-6 py-4">
              <div className="flex items-center gap-4">
                <div className="w-10 h-10 bg-slate-300 rounded-full flex items-center justify-center cursor-pointer">
                  <svg
            ...
            <td className="px-6 py-4">
              <div
                className="w-20 h-10 bg-[#FB7D5B] rounded-full flex items-center justify-center"
                style={{ padding: "4px 8px" }}
              >
                <span className="text-white ">VII A</span>
              </div>
            </td>
            <td className="px-6 py-4">
