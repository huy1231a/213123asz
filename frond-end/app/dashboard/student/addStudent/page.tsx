import FormInput1 from "@/app/ui/addStudentLayout/formInput1";
import FormInput2 from "@/app/ui/addStudentLayout/formInput2";
      ...
      <div className="flex justify-end">
        <div className="mt-6 inline-flex items-center justify-center gap-4">
          ...
          <div
            ...
            style={{ padding: "10px 24px" }}
          >
            <span className="text-[white] flex items-center justify-center">Submit</span>
          </div>
        </div>
      </div>
    </>
