...
const RightBarUser = () => {
  return (
    <>
      ...
      <div className="w-[386px] h-[370px] bg-[#4D44B5] rounded-2xl mt-10 ml-2 text-[white]">
        ...
        <div className="text-white w-[400px] h-[400px] bg-red-400 p-5 flex gap-4 relative">
          Parrent
          <div className="bg-purple-500 rounded-full w-[100px] h-[294px] absolute top-20 left-4">
            one
            <div className="bg-amber-200 w-8 h-8 rounded-full"></div>
          </div>
          <div className="bg-green-500 rounded-full w-[100px] h-[294px]">
            two
          </div>
          <div className="bg-slate-400 rounded-full">Three</div>
        </div>
      </div>
    </>
  );
